package ru.mirea.razakov.thread;
...
import ru.mirea.razakov.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 03, НОМЕР ПО СПИСКУ: 6, МОЙ ЛЮБИМЫЙ ФИЛЬМ: Вторая жизнь Уве");
