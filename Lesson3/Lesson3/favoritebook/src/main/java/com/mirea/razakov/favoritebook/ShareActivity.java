package ru.mirea.razakov.favoritebook;
...
public class ShareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewDeveloperBook.setText("Любимая книга разработчика: Мартин Иден");
        textViewQuote.setText("Цитата: Все в мире непрочно, кроме любви.");
