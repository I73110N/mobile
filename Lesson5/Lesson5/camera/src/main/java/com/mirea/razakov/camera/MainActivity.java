package ru.mirea.razakov.camera;
...
import ru.mirea.razakov.camera.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonCapture.setOnClickListener(v -> {
                binding.imageView.setImageResource(R.drawable.example_photo);
        });
    }
